      ...
      <div id="about-descr-container">
        ...
        <div id='about-descr'>
          ...
          <div id="about-descr-p2" className="about-p">
            ...
            mine and I constantly seek out challenges and opportunities to push
            myself and grow as an engineer.{" "}
          </div>
          <div id="about-descr-p3" className="about-p">
            I take initiative in terms of refining processes, asking questions and
            coming up with a plethora of approaches/solutions for any given
            task/problem, and am eager to contribute my self-starter mentality and
            array of skills to an innovative workplace with a highly motivated
            team.
          </div>
        </div>
      </div>
